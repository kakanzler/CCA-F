...
1. Click Connect: Select the connector you want to add
1. Authenticate: You'll be redirected to the service's login page. Sign in with your existing credentials
1. Grant permissions: Review the specific permissions Claude is requesting, then authorize access
1. Test the connection: Return to Claude and try a simple request, like "Can you access my [tool name]?"
1. Once connected, Claude can search, read, and in some cases take actions within that service—depending on the permissions you've granted.
...
1. Browse available extensions and click Install
1. Follow any additional setup steps specific to that extension
