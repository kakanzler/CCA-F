...
1. Click "Set up for your org" to continue (or "Disable" to turn the feature off).
1. Connect your organization's tools. You'll be required to choose a connector for Documents (like Google Drive or SharePoint) and Chat (like Slack or Microsoft Teams). Email is recommended but optional.
1. Click "+ Add more" to set up any additional tools your team needs.
1. Customize the project name. Whatever you enter will appear as "Ask [Name]" in everyone's sidebar.
1. Add a description, then click "Finish set up."
...
1. Follow the guided onboarding flow to connect to the recommended services.
1. Authenticate with each service you want to search (Slack, Google, Microsoft 365, etc.).
1. Start asking Claude questions about your organization's knowledge.
