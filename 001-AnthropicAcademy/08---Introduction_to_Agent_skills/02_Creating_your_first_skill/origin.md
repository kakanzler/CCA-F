...
```yaml
name : backend-review
description: Review backend code for security issuesand compliance mishapes.
```
-> Claude will ask "Use this backend skill?"
...
1. *Personal* — your home directory (`~/.claude/skills`)
1. *Project* — the `.claude/skills` directory inside a repository
1. *Plugins* — installed plugins, lowest priority
